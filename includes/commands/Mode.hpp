...
class Mode : public Command
{
  public:
	...
	bool executeMode(char mode,
	                 bool removeMode); /* Dispatches the mode to the correct command */
  ...
  private:
	...
	std::vector< std::string >
	  _params; // Represents potential parameters required by specific modes (+k, +b)
	std::string _target;
	int         _targetType;
	std::string _modes;
	std::string _reply;
	...
	bool _inviteOrInvis(bool removeMode);
